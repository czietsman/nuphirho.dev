---
title: "Don't ask, don't tell AI governance"
slug: "dont-ask-dont-tell-ai-governance"
tags: [ai-governance, personal-practice]
...
cover_post: |
  ...
  It was probably written before generative AI was relevant, or drafted in the past year and never formally communicated. New hires are signing something that existing staff never received. In some organisations, there is nothing at all and the BYOD policy is being stretched to cover the gap.

  When something goes wrong (customer data processed through an unapproved tool, a breach investigation, a regulator asking what controls were in place) this document becomes the basis for the response.
