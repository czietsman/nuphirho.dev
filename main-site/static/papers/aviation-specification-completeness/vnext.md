...
**Date:** 2 June 2026 (Section 8 v2 results added; updated from 25 May 2026 draft, SO6 draft 19 May 2026)
**Classification:** Project-private (pre-submission)
**Status:** Blogger quality gate applied 3 June 2026. Five targeted edits applied post-crit round (SO9, 3 June 2026): novelty claim rewrite (Fix 5), cross-sector qualification (Fix 1), proof surface antecedents (Fix 3), Candes citation removed (Fix 3), risk-proportionate stub table (Fix 4), circularity acknowledgement (Fix 2). Fix 6 applied post-metacrit round (SO9, 3 June 2026): causal mechanism, epoché grounding, and progressive approximation paragraph added to Section 5. Fix 7 applied: ACAS Xu derivation clarification added to Section 6. Fix 8 applied: RAG and continuously adapting systems generalisation note added to Section 4.1. Reference corrections applied: Bloomfield/Bishop (pp added), Damour et al. (title), He/Yu (title and authors), Koch/Wellbrock (title and authors), CNIL (title and URL), Korea (title), METI (year, URL, issuing bodies). Double-dash instances fixed (38 resolved; 2 retained in reference titles as published). Empirical figure updated: 82% → 94% (32/34) in three locations. Director review and outstanding citation checks required before arXiv submission.
  Finding number labels removed. Non-determinism precision added
  to Section 3.1. Internal model confirmation language removed.
  Gabreau 2024 title corrected. D1-D5 markers stripped from
  references. Corpus re-scoring sentence: flag to Blogger.
  Requires Blogger quality gate and Director review before
  arXiv submission.
...
**Affiliation:** Nuphirho Research. nuphirho.dev

**Author note:** The empirical corpus and verification
methodology for the findings cited in this paper are
documented in arXiv:2604.21090 and in the research
programme notes at nuphirho.dev.

**Word count:** Approximately 6,100 words (total file
including headers and references). Main body within the
6,000-8,000 word target.

**Status:** Third draft. All must-apply and should-apply
changes from meta-critique synthesis applied (19 May 2026).
Seven-principle corpus re-scoring complete and incorporated
into Section 8 (2 June 2026). Deferred items: formal SLR /
Structured Regulatory Corpus Audit write-up, cost/feasibility
section, independent PromptQ validation.

**Pre-submission checklist:**
- [x] Stop-Slop score: 36/50 (Directness 7, Rhythm 7, Trust 8, Authenticity 7, Density 7; no double-dash penalty; above 35/50 minimum, below 40/50 target; score reflects academic register)
- [x] Toulmin score: Track A 6/6 (Claim 2, Data 2, Warrant 2), Track B 6/6 (Backing 2, Rebuttal 2, Qualifier 2); exceeds arXiv minimum
- [x] CoDANN I date corrected: March 2020
- [x] CoDANN II date corrected: May 2021
- [x] "Bidirectional traceability" → "structured governance
      linkage" for natural language contexts
- [x] "Confirmed" → "indicated by structured regulatory
      corpus audit"
- [x] 37% qualified as five-principle lower bound; seven-principle re-scoring complete: 94% (32/34) below threshold, P7 = 0.00 universally (Zietsman 2026b)
- [x] "Choice not limitation" softened
- [x] ACAS Xu civilian airspace clarification added
- [x] DO-330 analogy-not-equivalence marker added
- [x] Assumption epoch limit maturity note added
- [x] Risk-scaling + PromptQ score paragraph added
- [x] F27/F28/F29 labels removed from abstract (SO8, 25 May 2026)
- [x] "systematic literature review pending" removed from
      abstract (SO8, 25 May 2026)
- [x] Phase 2 / five-model consensus language removed from
      Sections 2.1 and 2.2 (SO8, 25 May 2026)
- [x] SO8-introduced double-dashes fixed (SO8, 25 May 2026)
- [x] Sceptical objection paragraph added to Section 5:
      why governance documents are not just informal specs
      and why the AI case is harder than software (SO8,
      25 May 2026)
- [x] Remaining double-dashes throughout paper: one prose instance fixed (line 379, commas); two retained in published reference titles (exempt).
- [x] Cross-sector confirmation table expanded to full
      eight-sector and multilingual prose (SO8, 25 May 2026)
- [x] Section 7 proof surface: GSN/Kelly and Weaver (2004)
      citation and connecting paragraph added (SO8, 25 May 2026)
- [x] Kelly and Weaver (2004), CNIL (2022), Korea (2025),
      METI (2022), CISA Five Eyes (2026) added to references
      (SO8, 25 May 2026)
- [x] All citations D1-D5 verified. All 21 citations fully cleared. Lincoln (2025) D5 confirmed: abstract verbatim states "need for clear, concise, and unambiguous requirements for AI software." Kelly/Weaver D2 confirmed. He/Yu and Koch/Wellbrock D2-D5 confirmed from source files. All other citations cleared in SO9.
- [x] Director review (22 June 2026)
- [x] Blogger quality gate (Blogger reviewed 3 June 2026; Director confirmed)
- [x] Steve Kroon endorsement

---

Science Officer
nuphirho.dev research programme
2 June 2026 (Section 8 v2 results incorporated)
