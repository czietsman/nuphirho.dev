...
\section{2. The Correlated Error Hypothesis}

\subsection{2.1 The Structural Problem}
...
\subsection{2.2 The Empirical Evidence}
...
\subsection{2.3 A Constructed Illustration}
...
\subsection{2.4 The Independence Condition}
...
\subsection{2.5 Experimental Evidence}
...
\centering
\small
\begin{tabular}{p{3.2cm}p{2cm}p{0.8cm}p{0.8cm}p{0.8cm}p{0.8cm}p{0.8cm}}
\toprule
...
\%\%CODE0\%\% case: the swapped values are plausible on naive
...
contained an unused \%\%CODE0\%\% import in the gas day function that acted
...
\section{3. The Cynefin Domain Transition Hypothesis}

\subsection{3.1 The Constraint Distinction}
...
\subsection{3.2 Constraint Transformation as Domain Shift}
...
\subsection{3.3 What AI Makes Economically Viable}
...
\subsection{3.4 A Likely Objection}
...
\section{4. The Residual Defect Taxonomy}

\subsection{4.1 Theoretical Grounding: The Oracle Problem}
...
\subsection{4.2 The Proposed Taxonomy}
...
\subsection{4.3 Implications for the Architecture}
...
\section{5. The Combined Architecture and What Remains Open}

\subsection{5.1 The Architecture}
...
\subsection{5.2 What Remains Open}
