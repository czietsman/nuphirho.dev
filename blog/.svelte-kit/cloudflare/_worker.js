...
function unflatten(parsed, revivers) {
  ...
  let hydrating2 = null;
  function hydrate3(index4, standalone = false) {
    ...
    if (!value || typeof value !== "object") {
      ...
      if (typeof value[0] === "string") {
        ...
        if (reviver) {
          ...
          hydrating2.add(i);
          hydrated[index4] = reviver(hydrate3(i));
          hydrating2.delete(i);
        ...
        switch (type) {
          ...
          case "Object": {
            ...
            hydrated[index4] = Object(hydrate3(wrapped_index));
            break;
          }
          case "BigInt":
          ...
          case "DataView": {
            ...
            hydrated[index4] = value[2] !== void 0 ? new TypedArrayConstructor(buffer2, value[2], value[3]) : new TypedArrayConstructor(buffer2);
            break;
          }
          case "ArrayBuffer": {
...
// .svelte-kit/output/server/chunks/dev.js
...
function pop(component4) {
  ...
  if (component4 !== void 0) context3.x = component4;
  context3.i = true;
...
function render(component4, options2 = {}) {
  ...
  return Renderer.render(component4, options2);
}
...
var init_dev = __esm({
  ".svelte-kit/output/server/chunks/dev.js"() {
    ...
    Renderer = class Renderer2 {
      ...
      */
      title(fn) {
        ...
        this.child((renderer) => {
          ...
          else close(r3.#collect_content().head);
        });
      }
      /**
      ...
      */
      static render(component4, options2 = {}) {
        ...
        Object.defineProperties(result, {
          html: { get: () => {
            return (sync ??= Renderer2.#render(component4, options2)).body;
          } },
          head: { get: () => {
            return (sync ??= Renderer2.#render(component4, options2)).head;
          } },
          body: { get: () => {
            return (sync ??= Renderer2.#render(component4, options2)).body;
          } },
          ...
          then: { value: (onfulfilled, onrejected) => {
            if (!async_mode_flag) {
              const result2 = sync ??= Renderer2.#render(component4, options2);
            ...
            async ??= init_render_context().then(() => with_render_context(() => Renderer2.#render_async(component4, options2)));
      ...
      */
      *#collect_on_destroy() {
        for (const component4 of this.#traverse_components()) yield* component4.#collect_ondestroy();
      }
      /**
      ...
      */
      static #render(component4, options2) {
        ...
        try {
          const renderer = Renderer2.#open_render("sync", component4, options2);
      ...
      */
      static async #render_async(component4, options2) {
        const previous_context = ssr_context;
        try {
          const renderer = Renderer2.#open_render("async", component4, options2);
...
var __defProp2, __exportAll, base, assets, app_dir, initial, public_env, index_server_exports;
...
var text_encoder2, INVALIDATED_PARAM, TRAILING_SLASH_PARAM, remote_object, remote_map, remote_set, remote_arg_marker;
...
function mount2(component4, options2) {
  return _mount(component4, options2);
}
function hydrate2(component4, options2) {
  init_operations();
  ...
  try {
    ...
    const instance = _mount(component4, {
      ...options2,
      anchor
    });
    set_hydrating(false);
    ...
    set_hydrating(false);
    return mount2(component4, options2);
  } finally {
...
function _mount(Component, { target, anchor, props = {}, events, context: context3, intro = true, transformError }) {
  ...
  mounted_components.set(component4, unmount3);
  return component4;
}
function unmount2(component4, options2) {
...
function asClassComponent(component4) {
  ...
  const _render = (props, { context: context3, csp, transformError } = {}) => {
    const result = render(component4, {
      props,
      context: context3,
      csp,
      transformError
...
function Root($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let { stores: stores2, page: page4, constructors, components = [], form, data_0 = null, data_1 = null } = $$props;
    setContext("__svelte__", stores2);
    stores2.page.set(page4);
...
var read_implementation, event_symbol, all_registered_events, root_event_handles, last_propagated_event, listeners, mounted_components, Svelte4Component, options;
...
<head>
	...
	<script>
		// Apply theme before body renders to avoid flash
		(function(){
			var k='nuphirho-theme';
...
function _layout($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    let { children } = $$props;
    $$renderer2.push(`<a href="#main" class="skip-link">Skip to content</a> <header class="site-header"><div class="container"><a href="https://nuphirho.dev" class="site-name" aria-label="nuphirho home">nuphirho</a> <nav class="site-nav" aria-label="Main navigation"><a href="/about"${attr("aria-current", store_get($$store_subs ??= {}, "$page", page2).url.pathname === "/about" ? "page" : void 0)}>This Blog</a> <a href="https://nuphirho.dev/words-of-meaning">Words</a> <a href="/"${attr("aria-current", store_get($$store_subs ??= {}, "$page", page2).url.pathname === "/" ? "page" : void 0)}>Posts</a> <button id="theme-toggle" class="theme-toggle" type="button"${attr("aria-label", "Switch to dark theme")}>${escape_html("Dark")}</button></nav></div></header> <main id="main" class="site-main">`);
    children($$renderer2);
    $$renderer2.push(`<!----></main> <footer class="site-footer"><div class="container"><span>\xA9 2026 Christo Zietsman</span> <span class="footer-links"><a href="https://doi.org/10.48550/arXiv.2603.25773">arXiv Paper 1</a> <a href="https://doi.org/10.48550/arXiv.2604.21090">arXiv Paper 2</a> <a href="https://github.com/czietsman">GitHub</a> <a href="https://www.linkedin.com/in/christo-zietsman/">LinkedIn</a> <a href="https://nuphirho.dev/privacy">Privacy</a> <a href="https://nuphirho.dev/cookies">Cookies</a></span></div></footer>`);
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    ...
    imports = ["_app/immutable/nodes/0.DpZu6CNe.js", "_app/immutable/chunks/Cvc1K2yR.js", "_app/immutable/chunks/bIT_w4Yp.js", "_app/immutable/chunks/xihTtKlq.js"];
    stylesheets = ["_app/immutable/assets/0.BkIMbwug.css"];
    fonts = [];
  }
});
...
function Error$1($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    $$renderer2.push(`<h1>${escape_html(page3.status)}</h1> <p>${escape_html(page3.error?.message)}</p>`);
  });
}
var page3;
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    ...
    imports2 = ["_app/immutable/nodes/1.uegtCWoj.js", "_app/immutable/chunks/Cvc1K2yR.js", "_app/immutable/chunks/bIT_w4Yp.js", "_app/immutable/chunks/xihTtKlq.js"];
    stylesheets2 = [];
    fonts2 = [];
  }
});
...
function _page($$renderer) {
  head("cwls5q", $$renderer, ($$renderer2) => {
    $$renderer2.title(($$renderer3) => {
      $$renderer3.push(`<title>This Blog \u2014 nuphirho</title>`);
    });
    $$renderer2.push(`<meta name="description" content="About nuphirho \u2014 software engineering, process, and AI."/>`);
  });
  $$renderer.push(`<div class="container"><div class="about-content"><h1 class="post-title">This Blog</h1> <p>Writing about software engineering, process, and the way AI is changing both.</p> <h2>About the author</h2> <p>I am Christo Zietsman. I build software and research how to build it better \u2014
			specification-driven development, AI-assisted quality assurance, and the organisational
			patterns that let good engineering actually happen.</p> <h2>Links</h2> <ul class="about-links"><li><a href="https://nuphirho.dev">nuphirho.dev</a> \u2014 main site</li> <li><a href="https://nuphirho.dev/words-of-meaning">Words of Meaning</a> \u2014 language notes</li> <li><a href="https://github.com/czietsman">GitHub</a></li> <li><a href="https://www.linkedin.com/in/christo-zietsman/">LinkedIn</a></li> <li><a href="https://doi.org/10.48550/arXiv.2603.25773">arXiv Paper 1</a></li> <li><a href="https://doi.org/10.48550/arXiv.2604.21090">arXiv Paper 2</a></li></ul></div></div>`);
}
...
var init__3 = __esm({
  ".svelte-kit/output/server/nodes/4.js"() {
    ...
    imports3 = ["_app/immutable/nodes/4.PaP4bHB0.js", "_app/immutable/chunks/Cvc1K2yR.js", "_app/immutable/chunks/xihTtKlq.js"];
    stylesheets3 = [];
    fonts3 = [];
  }
});

// .svelte-kit/output/server/entries/endpoints/api/visit/_server.ts.js
...
var init_server_ts = __esm({
  ".svelte-kit/output/server/entries/endpoints/api/visit/_server.ts.js"() {
    ...
    POST = async ({ request, platform }) => {
      ...
      if (!path || typeof path !== "string") return json({ error: "path required" }, { status: 400 });
      const kv = platform?.env?.BLOG_ANALYTICS;
      if (!kv) return json({ count: 0 });
      const key2 = `visits:${path}`;
      const current2 = parseInt(await kv.get(key2) ?? "0", 10);
      await kv.put(key2, String(current2 + 1));
      return json({ count: current2 + 1 });
    };
  }
});
...
async function deserialize_binary_form(request) {
  ...
  const file_spans = [];
  const [data, meta] = parse(decoder.decode(data_buffer), { File: ([name, type, size, last_modified, index4]) => {
    if (typeof name !== "string" || typeof type !== "string" || typeof size !== "number" || typeof last_modified !== "number" || typeof index4 !== "number") throw deserialize_error("invalid file metadata");
...
`;
      return {
        ...
        chunks: promise_id > 1 ? iterator.iterate(({ index: index4, str }) => {
          if (max_nodes > -1 && index4 >= max_nodes) return "";
...
function generate_route_object(route, url, manifest2) {
  ...
  const nodes = [
    ...
    ...layouts.map((l) => l?.[1]),
    leaf[1]
  ].filter((n2) => typeof n2 === "number").map((n2) => `'${n2}': () => ${create_client_import(manifest2._.client.nodes?.[n2], url)}`).join(",\n		");
  return [
    `{
	id: ${s(route.id)}`,
...
var PageNodes = class {
  ...
  */
  ...
  validate() {
    ...
    const page4 = this.page();
    if (page4) {
      validate_page_server_exports(page4.server, page4.server_id);
      validate_page_exports(page4.universal, page4.universal_id);
    }
  }
  /**
...
async function handle_remote_call_internal(event, state2, options2, manifest2, id) {
  ...
  try {
    if (internals.type === "query_batch") {
      ...
      const args = await Promise.all(payloads.map((payload3) => parse_remote_arg(payload3, transport)));
      return json({
        type: "result",
        result: stringify2(await with_request_store({
          event,
          state: state2
    ...
    if (internals.type === "query_live") {
      ...
      const payload3 = new URL(event.request.url).searchParams.get("payload");
    ...
    const payload2 = internals.type === "prerender" ? additional_args : new URL(event.request.url).searchParams.get("payload");
    return json({
      type: "result",
      result: stringify2(await with_request_store({
        event,
        state: state2
      }, () => fn(parse_remote_arg(payload2, transport))), transport)
    });
  } catch (error2) {
  ...
  async function serialize_singleflight(map) {
    ...
    const results = await Promise.all(Array.from(map, async ([key2, promise]) => {
      try {
        return [key2, {
          type: "result",
          data: await promise
...
var MAX_DEPTH = 10;
async function render_page(event, event_state, page4, options2, manifest2, state2, nodes, resolve_opts) {
  if (state2.depth > MAX_DEPTH) return text(`Not found: ${event.url.pathname}`, { status: 404 });
  if (is_action_json_request(event)) return handle_action_json_request(event, event_state, options2, (await manifest2._.nodes[page4.leaf]())?.server);
  try {
    ...
    for (let i = 0; i < nodes.data.length; i += 1) {
      ...
      if (node) try {
        ...
        while (i--) if (page4.errors[i]) {
          const index4 = page4.errors[i];
          ...
          return await render_response({
            ...
            status: status2,
            error: error2,
            error_components: await load_error_components(options2, ssr, error_branch, page4, manifest2),
            branch: error_branch,
            fetched,
            data_serializer
          });
    ...
    return await render_response({
      ...
      error_components: await load_error_components(options2, ssr, branch2, page4, manifest2)
    });
  } catch (e3) {
    if (e3 instanceof Redirect) return redirect_response(e3.status, e3.location);
...
async function load_error_components(options2, ssr, branch2, page4, manifest2) {
  ...
  if (options2.server_error_boundaries && ssr) {
    ...
    error_components = await Promise.all(branch2.map((b, i) => {
      ...
      if (!b) return null;
      i--;
      while (i > last_idx + 1 && page4.errors[i] === void 0) i -= 1;
      last_idx = i;
      const idx = page4.errors[i];
      ...
      return once2(async () => {
        try {
          ...
          return load_server_data({
            ...
            event_state,
            state: state2,
            node: n2 == void 0 ? n2 : await manifest2._.nodes[n2](),
            parent: async () => {
              const data2 = {};
              for (let j = 0; j < i; j += 1) {
  ...
  try {
    ...
    if (route && !remote_id) {
      ...
      if (state2.before_handle || state2.emulator?.platform) {
        ...
        if (state2.before_handle) return await state2.before_handle(event, config, prerender, handle);
      }
    }
    return await handle();
  } catch (e3) {
...
function load_page_nodes(page4, manifest2) {
  return Promise.all([...page4.layouts.map((n2) => n2 == void 0 ? n2 : manifest2._.nodes[n2]()), manifest2._.nodes[page4.leaf]()]);
}
...
var manifest = (() => {
  ...
  return {
    appDir: "_app",
    appPath: "_app",
    assets: /* @__PURE__ */ new Set([".gitkeep"]),
    mimeTypes: {},
    _: {
      ...
      prerendered_routes: /* @__PURE__ */ new Set(["/", "/__data.json", "/conways-law-at-level-5", "/conways-law-at-level-5/__data.json", "/wardley-was-right", "/wardley-was-right/__data.json", "/i-followed-the-problem-home", "/i-followed-the-problem-home/__data.json", "/treating-ideas-as-releasable-software", "/treating-ideas-as-releasable-software/__data.json"]),
      matchers: async () => {
        return {};
      },
      server_assets: {}
...
var prerendered = /* @__PURE__ */ new Set(["/", "/__data.json", "/conways-law-at-level-5", "/conways-law-at-level-5/__data.json", "/wardley-was-right", "/wardley-was-right/__data.json", "/i-followed-the-problem-home", "/i-followed-the-problem-home/__data.json", "/treating-ideas-as-releasable-software", "/treating-ideas-as-releasable-software/__data.json"]);
var base_path = "";
  ...
  async fetch(req, env, context3) {
    ...
    if (is_static_asset || prerendered.has(pathname) || pathname === version_file || pathname.startsWith(immutable)) {
      ...
      res = await server.respond(req, {
        // @ts-ignore
        platform: { env, context: context3, caches, cf: req.cf },
        getClientAddress() {
